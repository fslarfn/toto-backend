// ==========================================================
// 🚀 SERVER.JS (FINAL - CLEANED, NO DUPLICATE DECLARATIONS)
//      Versi: Mengikuti kode asli Faisal, hanya hapus duplikat
// ==========================================================
...
const FALLBACK_DB = process.env.FALLBACK_DATABASE_URL || 'postgresql://postgres:password@127.0.0.1:5432/railway';
...
app.post('/api/login', async (req, res) => {
  try {
    ...
    // Support both password_hash or password column depending DB
...
// (DIPERTAHANKAN SESUAI ASLI — SAMA PERSIS LOGIKA KAMU)
// =============================================================
